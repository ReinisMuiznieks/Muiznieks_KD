...
const { addUserLearn, getLearn, getUserLearn, getUserLearnByCategoryId, deleteUserLearn, editUserLearn, patchUserLearn, getUserLearnByUserId } = require('../controllers/userLearnController')
const { isAdmin, protect } = require('../middleware/authMiddleware')

router.get('/', protect, getUserLearn)
